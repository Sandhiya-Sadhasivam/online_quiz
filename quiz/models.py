...
class MyUser(models.Model):
    ...
    phone_number_1 = models.CharField(validators=[phone_regex], max_length=17, blank=False,
                                      verbose_name='Participant 1 Phone Number')
    ...
    phone_number_2 = models.CharField(validators=[phone_regex], max_length=17, blank=True,
                                      verbose_name='Participant 2 Phone Number')
...
class Question(models.Model):
    CATEGORY_CHOICES = [('Level one', 'Level 1'), ('Level two', 'Level 2'), ('Level three', 'Level 3')]
    ...
    category = models.CharField(max_length=11, default='C++', verbose_name='Category', choices=CATEGORY_CHOICES)
